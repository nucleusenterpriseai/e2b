...
hostnamectl set-hostname "${prefix}-api-$${INSTANCE_ID}"
...
# --- Generate Nomad client configuration (API services run as Nomad jobs) ---
mkdir -p /etc/nomad.d
...
# --- Start Nomad agent (client mode for API services) ---
systemctl enable nomad
systemctl start nomad

echo "API node initialization complete."
